...
def main():
    ...
    if(len(sys.argv) != 2):
        print("Usage: python nn_topics <mode> (1: Convolution Network 2: FeedForward)")
        exit(0)
    type = int(sys.argv[1])
            ...
            for epoch in range(num_epochs):  # loop over the dataset multiple times
                ...
                for i, data in enumerate(trainloader, 0):
                    ...
                    if i % logStep == logStep - 1:    # print every logStep mini-batches
                        ...
                        trainAccuracy = getAccuracy(net, Xtrain, xCols, tCols)
                        testAccuracy = getAccuracy(net, Xtest, xCols, tCols)
