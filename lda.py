...
for file in files:
    ...
    # Run LDA
    lda = LatentDirichletAllocation(n_components=no_topics, max_iter=300, doc_topic_prior=0.3, topic_word_prior=.9, learning_method='online', learning_offset=50.,random_state=0).fit(tf)
